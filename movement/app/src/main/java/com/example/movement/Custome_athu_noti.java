...
public class Custome_athu_noti extends ArrayAdapter<String>  {
    ...
    public Custome_athu_noti(Activity context,String[] titl, String[] comp, String[] date) {
        //constructor of this class to get the values from main_activity_class

        super(context, R.layout.activity_custome_athu_noti, titl);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_custome_athu_noti, null, true);
