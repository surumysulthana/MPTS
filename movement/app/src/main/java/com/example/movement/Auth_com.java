...
public class Auth_com extends AppCompatActivity implements JsonResponse{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auth_com);
        ...
        JR.json_response = (JsonResponse) Auth_com.this;
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(feedback.equalsIgnoreCase("")){
                    ...
                    JsonReq JR = new JsonReq();
                    JR.json_response = (JsonResponse) Auth_com.this;
                    String q = "/authocomp?feed=" + feedback + "&loginid=" + sh.getString("log_id","")+"&title="+title;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
            }
