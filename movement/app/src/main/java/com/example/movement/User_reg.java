    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    e3.setError("Enter your place name");
...
//            String uploadUrl = "http://" + IPSetting.ip + "/api/upload_pdf";
            String uploadUrl = "http://" + IPSetting.ip + "/user_reg" ;
            ...
            fileUploadAsync.json_response = User_reg.this;
    ...
    private void selectPdfOption() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(User_reg.this);
